...
//               onChange={(e) => setname(e.target.value)}
//             />
//             {name.length < 2 && accept && <p>user is required</p>}
//             <label htmlFor="email">email</label>
//             <input
//               id="email"
//               placeholder="email"
...
//               onChange={(e) => setemail(e.target.value)}
//             />
//             {accept && EmailError && <p> email already token</p>}
//             <label htmlFor="password">password</label>
//             <input
//               id="password"
//               placeholder="password"
...
//               <p style={{ color: "red" }}>password must be more 8 ch</p>
//             )}
...
//               onChange={(e) => setreptpass(e.target.value)}
//             />
//             {reptpass !== password && accept && (
//               <p style={{ color: "red" }}>repetpassword must be=password</p>
//             )}
//             <div style={{ textAlign: "center" }}>
//               <button type="submit">Register</button>
//             </div>
